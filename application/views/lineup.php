  ...
  <header id="header" class="header-fixed">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        ...
        <a href="index.html#intro" class="scrollto"><img src="<?= base_url(); ?>assets/img/logo.png" alt="" title=""></a>
      </div>
    ...
    <section id="speakers-details" class="wow fadeIn">
      <div class="container">
        <div class="section-header">
          ...
          <p>Line Up Oh! Nais Festival 2020</p>
        </div>

        <div class="row">
          <div class="col-md-6">
            <img src="<?= base_url(); ?>assets/img/speakers/1.jpg" alt="Speaker 1" class="img-fluid">
          </div>
