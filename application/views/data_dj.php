...
<div class="card col-12">
    ...
    <h3 class="mt-3 card-tittle">Data DJ</h3>

    <div class="row">
                    <div class="col-12">

                        <p class="text-muted">Data DJ merupakan data DJ Synchronize.</p>
                        <div class="row">
                            ...
                            <div class="col-md-5 col-lg-3">
                                <div class="card" style="height: 500px;">
                                    <img src="<?php echo base_url('/assets/images/gs/'.$d->video) ?>" height="180px" />
                                    <div class="card-body">
                                        <h6 class="card-title text-center"><b><?php echo $d->nama_dj ?></b></h6>
                                        <p class="card-text text-center text-primary">Since : <?php echo $d->since ?></p>
                                        <p class="card-text text-left">Genre : <?php echo $d->genre ?></p>
                                        <p class="card-text text-left">Date of Birth : <?php echo $d->birth ?></p>
                                        <p class="card-text text-left">Alamat : <?php echo $d->alamat ?></p>
                                        <p class="card-text text-left">IG : <?php echo $d->sosmed ?></p>

                                        <a href="" class="btn btn-sm btn-block btn-light text-center" data-toggle="modal" data-target="#ubah_data" onclick="prepare_ubah('.$g->id_guest.')"><i class="fa fa-fw fa-info-circle"></i><b> Info </b>  </a>
            ...
            <button class="btn btn-block btn-info sweet-success" data-toggle="modal" data-target="#tambah_data"><i class="fa fa-fw fa-plus-circle"></i> Guest Star</button>
            <!-- MODAL TAMBAH DJ -->
            ...
            <div class="modal-dialog modal-lg" role="document">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalCenterTitle"><i class="fa fa-fw fa-star"></i> Tambah DJ</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                        <?php echo form_open("deje/tambah", array('enctype'=>'multipart/form-data')); ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" name="since" placeholder="year">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="inputPassword" class="col-sm-2 col-form-label">Sosmed <b class="text-danger">*</b></label>
                            <div class="col-sm-10">
                            <input type="text" class="form-control" name="sosmed" placeholder="Instagram">
                            </div>
                        </div>
                        <div class="form-group row">
            ...
            <!-- MODAL HAPUS -->
  					<div class="modal fade" id="hapus_data" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  					<div class="modal-dialog modal-dialog-centered" role="document">
  						...
  						<div class="modal-footer">
  							...
  							<a href="<?= base_url('guestar/delete'); ?>/<?= $g->id_guest ?>" class="btn btn-danger">Hapus</a>
  						</div>
  						</div>
  					</div>
  					</div>
