<div class="card col-12">
    ...
    <h3 class="mt-3 card-tittle">Ticket Synchronize</h3><br>
    <div class="row">
        <!-- End Col -->
        <div class="col-md-6 col-lg-3 ml-2">
            <div class="card">
                ...
                <h5 style="position:absolute; margin-top: 210px; margin-left:70px; z-index:2; color: white;"> Rp. 120,000</h5>
            </div>
        </div>
        <!-- End Col -->
        ...
        <div class="col-md-6 col-lg-3 ml-2">
            <div class="card">
                ...
                <h5 style="position:absolute; margin-top: 210px; margin-left:70px; z-index:2; color: white;"> Rp. 150,000</h5>
            </div>
        </div>
        <!-- End Col -->
    </div>
