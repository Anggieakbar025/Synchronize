...
class Mailer {
    protected $_ci;
    protected $email_pengirim = 'anggieakbar025@gmail.com'; // Isikan dengan email pengirim
    protected $nama_pengirim = 'Synchronize Management'; // Isikan dengan nama pengirim
    protected $password = 'abyan789'; // Isikan dengan password email pengirim
